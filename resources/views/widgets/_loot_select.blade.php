                ...
                <tr class="loot-row">
                    ...
                    <td class="loot-row-select">
                        ...
                        @elseif($loot->rewardable_type == 'Pet')
                            {!! Form::select($prefix . 'rewardable_id[]', $pets, $loot->rewardable_id, ['class' => 'form-control pet-select selectize', 'placeholder' => 'Select Pet']) !!}
                        @elseif($loot->rewardable_type == 'Weapon')
                            {!! Form::select($prefix . 'rewardable_id[]', $weapons, $loot->rewardable_id, ['class' => 'form-control weapon-select selectize', 'placeholder' => 'Select Weapon']) !!}
                        @elseif($loot->rewardable_type == 'Gear')
                            {!! Form::select($prefix . 'rewardable_id[]', $gears, $loot->rewardable_id, ['class' => 'form-control gear-select selectize', 'placeholder' => 'Select Gear']) !!}
                        ...
                        @elseif($loot->rewardable_type == 'Points' && $loot->rewardable_id)
                            {!! Form::select($prefix . 'rewardable_id[]', $stats, $loot->rewardable_id, ['class' => 'form-control points-select selectize', 'placeholder' => 'Select Stat']) !!}
                        @elseif($loot->rewardable_type == 'Exp')
                            {!! Form::text($prefix . 'rewardable_id[]', null, ['class' => 'form-control hide claymore-select', 'placeholder' => 'Enter Reward']) !!}
                        @endif
                    </td>
